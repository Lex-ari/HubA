...
#include <ADeployment/Top/ADeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    ADeployment::TopologyState inputs;
    ...
    ADeployment::setupTopology(inputs);
    ADeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    ADeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
